...
export function ChatWindow({ session, newSessionCwd, onAgentEnd, onSessionCreated, onSessionForked, modelsRefreshKey, chatInputRef, onBranchDataChange, onSystemPromptChange, onSessionStatsChange, onSessionStatsPanelOpen, onContextUsageChange, onOpenFile }: Props) {
  ...
  const {
    ...
    session, newSessionCwd, promptLocale: locale, onAgentEnd: wrappedOnAgentEnd, onSessionCreated, onSessionForked,
  ...
  return (
    ...
    >
          ...
          <div className="w-full max-w-[820px]">
            ...
            >
              ...
              <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 2, flexShrink: 0 }}>
                ...
                <span style={{ fontSize: 11, color: "var(--text-muted)" }}>
                  agent <span style={{ color: "var(--text)" }}>v{process.env.NEXT_PUBLIC_PI_VERSION ?? "0.0.0"}</span>
                </span>
              </div>
            </div>
      ...
      <div className="relative flex min-w-0 flex-1 overflow-hidden">
        ...
        <div ref={scrollContainerRef} className="min-w-0 flex-1 overflow-x-hidden overflow-y-auto pt-4 [scrollbar-width:none]" style={{ overflowAnchor: "none" }}>
