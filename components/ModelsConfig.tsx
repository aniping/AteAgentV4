...
import {
  ...
  type ModelConfigEntry as BaseModelEntry,
  type ModelsConfig as BaseModelsJson,
  type ProviderConfigEntry as BaseProviderEntry,
...
type ModelEntry = Omit<BaseModelEntry, "cost"> & {
  cost?: NonNullable<BaseModelEntry["cost"]> & { tiers?: unknown };
  headers?: Record<string, string>;
};

type ProviderEntry = Omit<BaseProviderEntry, "models"> & {
  models?: ModelEntry[];
};

type ModelsJson = Omit<BaseModelsJson, "providers"> & {
