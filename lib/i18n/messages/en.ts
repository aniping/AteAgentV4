...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "browser.embedNotice": "HTTP services on 127/localhost or a private address owned by this computer automatically use a compatibility preview. Other devices and public sites may still block embedding; use Open externally in that case.",
    "browser.proxyStarting": "Connecting to the local service…",
    "browser.proxyStartingDescription": "Creating a compatibility preview for this computer while preserving page, API, and WebSocket paths.",
    "browser.proxyFailed": "Local preview unavailable",
    "browser.proxyFailedDescription": "Make sure the service is running and use 127/localhost or a private HTTP address owned by this computer.",
    "sidebar.new": "New",
