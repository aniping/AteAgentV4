...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "browser.embedNotice": "Some sites block embedding or require a regular browser profile. An HTTPS workspace may also block plain-HTTP LAN previews. If a page stays blank, use HTTPS or Open externally.",
    "sidebar.new": "New",
