...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "i18n.uploadingSkillZip": "Uploading...",
    ...
    "i18n.skillZipTrustWarning": "Only install trusted ZIP files. Bundled runtime programs can be executed by Pi after installation.",
