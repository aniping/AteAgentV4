...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "files.resizePanel": "Resize file panel",
    "files.noneOpen": "No file open",
    "workspacePanel.hide": "Hide workspace",
    "workspacePanel.show": "Show workspace",
    "workspacePanel.resize": "Resize workspace",
    "workspacePanel.title": "Workspace",
    "workspacePanel.tabs": "Workspace tabs",
    "workspacePanel.newBrowser": "New browser preview",
    "workspacePanel.emptyTitle": "Files and web previews, side by side",
    "workspacePanel.emptyDescription": "Open project files or keep a local web app visible while you work with the agent.",
    "workspacePanel.openBrowser": "Open browser preview",
    "workspacePanel.openBrowserHelp": "Enter a local or public web address",
    "workspacePanel.openFile": "Open a project file",
    "workspacePanel.openFileHelp": "Choose one from the file explorer",
    "browser.newTab": "Browser",
    "browser.address": "Web address",
    "browser.addressPlaceholder": "localhost:3000 or https://example.com",
    "browser.go": "Go",
    "browser.back": "Back in address-bar history",
    "browser.forward": "Forward in address-bar history",
    "browser.reload": "Reload preview",
    "browser.openExternal": "Open externally",
    "browser.openExternalHelp": "Open in your regular browser; use this when a site blocks embedding",
    "browser.addressRequired": "Enter a web address.",
    "browser.invalidAddress": "That web address is not valid.",
    "browser.httpOnly": "Browser previews accept HTTP and HTTPS addresses only.",
    "browser.credentialsBlocked": "Remove the username or password from the address before opening it.",
    "browser.currentAppBlocked": "The current Wireless ATE Agent page cannot be embedded inside itself.",
    "browser.previewTitle": "Web preview: {url}",
    "browser.startTitle": "Preview a web app",
    "browser.startDescription": "Enter an HTTP(S) address. These shortcuts use the workspace host, so they also work when Wireless ATE Agent is opened over LAN.",
    "browser.quickLinks": "Common development ports",
    "browser.embedNotice": "Every HTTP IP address routable from this computer uses compatibility preview automatically, including WSL, LAN, and public addresses. HTTPS pages still use native browser framing.",
    "browser.proxyStarting": "Connecting to the target service…",
    "browser.proxyStartingDescription": "Creating a compatibility preview through the system network route while preserving page, API, and WebSocket paths.",
    "browser.proxyFailed": "Compatibility preview unavailable",
    "browser.proxyFailedDescription": "Make sure this address is directly reachable from the current computer and that the target HTTP service is running.",
    "sidebar.new": "New",
    ...
    "i18n.fileContent": "Contents of {file}",
    ...
    "i18n.documentPreview": "Document preview",
    "i18n.lineCount": "{count} lines",
    ...
    "i18n.skills": "Skills",
    "skills.currentAvailable": "Current available",
    "skills.manage": "Manage",
    "skills.add": "Add skill",
    "skills.currentAvailableHint": "Skills this conversation can use now",
    "skills.manageHint": "Manage loaded user skills and model invocation",
    "skills.addHint": "Install from skills.sh or a reviewed ZIP",
    "skills.searchAvailable": "Search available skills",
    "skills.searchManaged": "Search managed skills",
    "skills.sceneBuiltInGroup": "Scene built-in",
    "skills.currentProject": "Current project",
    "skills.allProjects": "All projects",
    "skills.globalGroup": "Global",
    "skills.customPath": "Custom path",
    "skills.modelCallable": "Model callable",
    "skills.manualOnly": "Manual only",
    "skills.intentMatched": "Intent matched",
    "skills.builtIntoScene": "Built into the current scene",
    "skills.whenAutomatic": "When is it used automatically?",
    "skills.whenAutomaticBody": "Its name and description are shown to the model. When your request matches, the model can load the full instructions; it is not forced on every turn.",
    "skills.manualCommandHint": "Use this command when you want to force this skill for the next request.",
    "skills.copy": "Copy",
    "skills.copied": "Copied",
    "skills.source": "Source",
    "skills.scope": "Scope",
    "skills.invocation": "Invocation",
    "skills.technicalPath": "Technical path",
    "skills.allowModel": "Allow model to invoke",
    "skills.readOnly": "Read-only",
    "skills.runtimeInventoryNote": "This is the runtime-effective list. If two sources provide the same skill, only the winning copy is shown.",
    "skills.noAvailable": "No skills are available in this conversation.",
    "skills.noProjectSkills": "No project skill is currently loaded.",
    "skills.noManaged": "No loaded user skills match this view.",
    "skills.all": "All",
    "skills.project": "Project",
    "skills.global": "Global",
    "skills.path": "Path",
    "skills.market": "skills.sh",
    "skills.localZip": "Local ZIP",
    "skills.addHelp": "Choose a reviewed source and installation scope.",
    "skills.marketPlaceholder": "Search skills.sh",
    "skills.marketEmpty": "Search skills.sh to discover and install skills for your agent.",
    "skills.resultCount": "{count} results",
    "skills.selectMarketSkill": "Select a skill to review its source and destination.",
    "skills.projectScope": "Current project",
    "skills.globalScope": "All projects",
    "skills.projectScopeDescription": "Available only when working in this project.",
    "skills.globalScopeDescription": "Available to every project on this computer.",
    "skills.recommended": "Recommended",
    "skills.alreadyInstalledHere": "Already installed in this scope",
    "skills.installedElsewhere": "Installed in the other scope",
    "skills.installProjectCopy": "Install for project",
    "skills.installGlobal": "Install globally",
    "skills.installDestination": "Destination",
    "skills.archiveInspecting": "Inspecting archive…",
    "skills.archiveReady": "Archive review complete",
    "skills.archiveStructurePassed": "Structure check passed",
    "skills.archiveIntegrityPassed": "Archive fingerprint recorded",
    "skills.archiveFileCount": "{count} files in archive",
    "skills.skillFileCount": "{count} files belong to the skill",
    "skills.archiveRiskTitle": "Review before installing",
    "skills.archiveRiskInstructions": "Instructions only: no bundled supporting files or runtime were declared.",
    "skills.archiveRiskSupporting": "This archive includes supporting files that the skill may read or use.",
    "skills.archiveRiskIntegration": "This archive includes an integration runtime that may be executed after installation.",
    "skills.mcpServer": "MCP server",
    "skills.executable": "Executable",
    "skills.requiredTools": "Required tools",
    "skills.environmentNames": "Environment variables",
    "skills.noneDeclared": "None declared",
    "skills.trustArchive": "I trust this archive and want to install it",
    "skills.trustArchiveBody": "The archive will be checked again against this exact fingerprint before any files are installed.",
    "skills.confirmInstall": "Confirm install",
    "skills.chooseZip": "Choose a ZIP file",
    "skills.replaceZip": "Choose another ZIP",
    "skills.dropZip": "or drag and drop it here",
    "skills.done": "Done",
    "skills.availableSummary": "{count} skills available now · {automatic} visible to the model",
    "skills.manageSummary": "{count} loaded user skills · {manual} manual only",
    "skills.addSummary": "New installs are loaded for future prompts in this session.",
    "skills.sceneContext": "{scene} scene · {project}",
    "skills.unknownScene": "No scene",
    "skills.installing": "Installing…",
    "skills.installedSuccess": "Installed {name}.",
    "skills.checkUpdates": "Check updates",
    "skills.updateAvailableCount": "{count} updates available",
    "i18n.plugins": "Plugins",
    "i18n.addSkill": "Add skill",
    "i18n.addPlugin": "Add plugin",
    "i18n.skillCatalogBefore": "Search ",
    "i18n.skillCatalogAfter": " to discover and install skills for your agent.",
    "i18n.installFromZip": "Install from ZIP",
    "i18n.installZip": "Install ZIP",
    "i18n.uploadingSkillZip": "Installing...",
    "i18n.chooseSkillZip": "Click to choose a ZIP file",
    "i18n.dropSkillZip": "or drag and drop it here",
    "i18n.skillZipSelected": "Selected · {size}",
    "i18n.replaceSkillZip": "Choose another",
    "i18n.selectZipBeforeInstall": "Choose ZIP first",
    "i18n.skillZipFileRules": ".zip only · up to {size}",
    ...
    "i18n.uninstallingArchive": "Uninstalling...",
    "i18n.uninstallArchiveConfirm": "Uninstall skill {name}? Its integration runtime and MCP configuration will also be removed.",
    "i18n.pluginSource": "Source",
    "i18n.examples": "Examples",
    "i18n.pluginCatalogBefore": "Browse ",
    "i18n.pluginCatalogAfter": " to discover and install Pi plugins for your agent.",
