...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "workspacePanel.hide": "隐藏工作区",
    "workspacePanel.show": "显示工作区",
    "workspacePanel.resize": "调整工作区宽度",
    "workspacePanel.title": "工作区",
    "workspacePanel.tabs": "工作区标签",
    "workspacePanel.newBrowser": "新建浏览器预览",
    "workspacePanel.emptyTitle": "把文件与网页放在对话旁边",
    "workspacePanel.emptyDescription": "打开项目文件，或在与 Agent 协作时持续查看本地 Web 应用。",
    "workspacePanel.openBrowser": "打开浏览器预览",
    "workspacePanel.openBrowserHelp": "输入本地或公开网页地址",
    "workspacePanel.openFile": "打开项目文件",
    "workspacePanel.openFileHelp": "从左侧文件树中选择",
    "browser.newTab": "浏览器",
    "browser.address": "网页地址",
    "browser.addressPlaceholder": "localhost:3000 或 https://example.com",
    "browser.go": "访问",
    "browser.back": "在地址栏历史中后退",
    "browser.forward": "在地址栏历史中前进",
    "browser.reload": "刷新预览",
    "browser.openExternal": "外部打开",
    "browser.openExternalHelp": "在常用浏览器中打开；站点拒绝嵌入时使用",
    "browser.addressRequired": "请输入网页地址。",
    "browser.invalidAddress": "网页地址格式无效。",
    "browser.httpOnly": "浏览器预览仅支持 HTTP 和 HTTPS 地址。",
    "browser.credentialsBlocked": "请先从地址中移除用户名或密码。",
    "browser.currentAppBlocked": "不能在 Wireless ATE Agent 中递归嵌入当前页面。",
    "browser.previewTitle": "网页预览：{url}",
    "browser.startTitle": "预览 Web 应用",
    "browser.startDescription": "输入 HTTP(S) 地址。下方快捷入口沿用当前工作区主机，因此通过局域网打开 Wireless ATE Agent 时也能正确定位。",
    "browser.quickLinks": "常用开发端口",
    "browser.embedNotice": "127/localhost 与当前电脑网卡实际拥有的私网 HTTP 地址会自动使用兼容预览；其他设备与公开站点仍可能禁止嵌入，此时请使用“外部打开”。",
    "browser.proxyStarting": "正在连接本机服务…",
    "browser.proxyStartingDescription": "正在建立仅限当前电脑地址的兼容预览，页面资源、接口与 WebSocket 会保持原路径。",
    "browser.proxyFailed": "无法建立本机预览",
    "browser.proxyFailedDescription": "请确认服务仍在运行，并使用 127/localhost 或当前电脑网卡实际拥有的私网 HTTP 地址。",
    "sidebar.new": "新建",
    ...
    "chat.compact": "压缩",
    "chat.compactSessionTooSmall": "目前没有足够的旧上下文可压缩。继续对话后再试。",
    ...
    "i18n.documentPreview": "文档预览",
    "i18n.lineCount": "{count} 行",
    ...
    "i18n.continuing": "继续中…",
    "i18n.skills": "技能",
    "skills.currentAvailable": "当前可用",
    "skills.manage": "管理",
    "skills.add": "添加技能",
    "skills.currentAvailableHint": "当前对话现在可以使用的技能",
    "skills.manageHint": "管理已加载的用户技能与模型调用权限",
    "skills.addHint": "从 skills.sh 或已检查的 ZIP 安装",
    "skills.searchAvailable": "搜索当前可用技能",
    "skills.searchManaged": "搜索可管理技能",
    "skills.sceneBuiltInGroup": "场景内置",
    "skills.currentProject": "当前项目",
    "skills.allProjects": "所有项目",
    "skills.globalGroup": "全局",
    "skills.customPath": "自定义路径",
    "skills.modelCallable": "模型可调用",
    "skills.manualOnly": "仅手动调用",
    "skills.intentMatched": "按意图匹配",
    "skills.builtIntoScene": "内置于当前场景",
    "skills.whenAutomatic": "什么时候会被自动使用？",
    "skills.whenAutomaticBody": "模型会看到这个技能的名称和描述。当你的需求与之匹配时，模型可以加载完整指令；它不会被强制用于每一轮对话。",
    "skills.manualCommandHint": "如果希望下一条需求强制使用这个技能，请输入这条命令。",
    "skills.copy": "复制",
    "skills.copied": "已复制",
    "skills.source": "来源",
    "skills.scope": "范围",
    "skills.invocation": "调用方式",
    "skills.technicalPath": "技术路径",
    "skills.allowModel": "允许模型调用",
    "skills.readOnly": "只读",
    "skills.runtimeInventoryNote": "这里展示的是运行时最终生效的列表。同名技能来自多个来源时，只展示优先级胜出的副本。",
    "skills.noAvailable": "当前对话没有可用技能。",
    "skills.noProjectSkills": "当前未加载项目级 Skill。",
    "skills.noManaged": "此视图中没有匹配的已加载用户技能。",
    "skills.all": "全部",
    "skills.project": "项目",
    "skills.global": "全局",
    "skills.path": "路径",
    "skills.market": "skills.sh",
    "skills.localZip": "本地 ZIP",
    "skills.addHelp": "选择已审核的来源和安装范围。",
    "skills.marketPlaceholder": "搜索 skills.sh",
    "skills.marketEmpty": "搜索 skills.sh，发现并安装适用于 Agent 的技能。",
    "skills.resultCount": "{count} 个结果",
    "skills.selectMarketSkill": "选择一个技能，确认来源与安装位置。",
    "skills.projectScope": "当前项目",
    "skills.globalScope": "所有项目",
    "skills.projectScopeDescription": "仅在这个项目中工作时可用。",
    "skills.globalScopeDescription": "这台电脑上的所有项目都可用。",
    "skills.recommended": "推荐",
    "skills.alreadyInstalledHere": "此范围内已安装",
    "skills.installedElsewhere": "已安装在另一个范围",
    "skills.installProjectCopy": "安装到项目",
    "skills.installGlobal": "全局安装",
    "skills.installDestination": "安装位置",
    "skills.archiveInspecting": "正在检查压缩包…",
    "skills.archiveReady": "压缩包检查完成",
    "skills.archiveStructurePassed": "结构检查通过",
    "skills.archiveIntegrityPassed": "已记录压缩包指纹",
    "skills.archiveFileCount": "压缩包内共 {count} 个文件",
    "skills.skillFileCount": "其中 {count} 个文件属于该技能",
    "skills.archiveRiskTitle": "安装前确认风险",
    "skills.archiveRiskInstructions": "仅包含指令：未声明附属文件或可执行运行时。",
    "skills.archiveRiskSupporting": "压缩包包含技能可能读取或使用的附属文件。",
    "skills.archiveRiskIntegration": "压缩包包含集成运行时，安装后可能被执行。",
    "skills.mcpServer": "MCP 服务",
    "skills.executable": "可执行程序",
    "skills.requiredTools": "依赖工具",
    "skills.environmentNames": "环境变量",
    "skills.noneDeclared": "未声明",
    "skills.trustArchive": "我信任这个压缩包并确认安装",
    "skills.trustArchiveBody": "写入任何文件前，系统会再次核对压缩包与本次检查记录的指纹完全一致。",
    "skills.confirmInstall": "确认安装",
    "skills.chooseZip": "选择 ZIP 文件",
    "skills.replaceZip": "重新选择 ZIP",
    "skills.dropZip": "或将文件拖放到这里",
    "skills.done": "完成",
    "skills.availableSummary": "当前可用 {count} 个技能 · {automatic} 个对模型可见",
    "skills.manageSummary": "已加载 {count} 个用户技能 · {manual} 个仅手动调用",
    "skills.addSummary": "新安装的技能会在本会话后续请求中加载。",
    "skills.sceneContext": "{scene}场景 · {project}",
    "skills.unknownScene": "未选择场景",
    "skills.installing": "正在安装…",
    "skills.installedSuccess": "已安装 {name}。",
    "skills.checkUpdates": "检查更新",
    "skills.updateAvailableCount": "有 {count} 个可用更新",
    "i18n.plugins": "插件",
    "i18n.addSkill": "添加技能",
    "i18n.addPlugin": "添加插件",
    "i18n.skillCatalogBefore": "访问 ",
    "i18n.skillCatalogAfter": "，发现并安装适用于你的 Agent 的技能。",
    "i18n.installFromZip": "从 ZIP 安装",
    "i18n.installZip": "安装 ZIP",
    "i18n.uploadingSkillZip": "正在安装...",
    "i18n.chooseSkillZip": "点击选择 ZIP 文件",
    "i18n.dropSkillZip": "或将文件拖放到这里",
    "i18n.skillZipSelected": "已选择 · {size}",
    "i18n.replaceSkillZip": "重新选择",
    "i18n.selectZipBeforeInstall": "选择 ZIP 后安装",
    "i18n.skillZipFileRules": "仅支持 .zip · 最大 {size}",
    ...
    "i18n.uninstallingArchive": "卸载中...",
    "i18n.uninstallArchiveConfirm": "卸载技能 {name}？对应的集成运行时和 MCP 配置也会被移除。",
    "i18n.pluginSource": "来源",
    "i18n.examples": "示例",
    "i18n.pluginCatalogBefore": "访问 ",
    "i18n.pluginCatalogAfter": "，发现并安装适用于你的 Agent 的 Pi 插件。",
