...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "browser.embedNotice": "所有可从当前电脑路由到的 HTTP IP 地址都会自动使用兼容预览，包括 WSL、局域网与公网地址；HTTPS 页面仍按浏览器原生规则嵌入。",
    "browser.proxyStarting": "正在连接目标服务…",
    "browser.proxyStartingDescription": "正在按系统网络路由建立兼容预览，页面资源、接口与 WebSocket 会保持原路径。",
    "browser.proxyFailed": "无法建立兼容预览",
    "browser.proxyFailedDescription": "请确认该地址可从当前电脑直接访问，且目标 HTTP 服务仍在运行。",
    "sidebar.new": "新建",
