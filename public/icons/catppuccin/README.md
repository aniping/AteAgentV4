...
- `latte/` is used in Wireless ATE Agent's light theme.
- `mocha/` is used in Wireless ATE Agent's dark theme.
- Wireless ATE Agent uses the SVG alpha channel as a mask and applies `var(--text-dim)`,
