...
- `latte/` is used in ATE Agent's light theme.
- `mocha/` is used in ATE Agent's dark theme.
- ATE Agent uses the SVG alpha channel as a mask and applies `var(--text-dim)`,
